...
resource "aws_codedeploy_deployment_group" "frontend" {
  ...
  deployment_group_name  = "frontend-deployment-group-prod"
  ...
  load_balancer_info {
    target_group_pair_info {
      ...
      target_group {
        name = "prod-alb-fe-blue-tg"
      }
      target_group {
        name = "prod-alb-fe-green-tg"
      }
    }
  }
...
resource "aws_codedeploy_deployment_group" "backend" {
  app_name               = aws_codedeploy_app.app.name
  deployment_group_name  = "backend-deployment-group-prod"
  service_role_arn       = aws_iam_role.codedeploy.arn
  deployment_config_name = "CodeDeployDefault.ECSAllAtOnce"
  ...
  load_balancer_info {
    target_group_pair_info {
      ...
      target_group {
        name = "prod-alb-be-blue-tg"
      }
      target_group {
        name = "prod-alb-be-green-tg"
      }
    }
  }
